...
<section className="home-section" id="home">
      <div className="home-content">
        ...
        <h3>We Provide  <span ref={typedElement}  className="multiple-text"></span>Service</h3>
        <p>
        At PetCenter, we're dedicated to enhancing the lives of pets and their owners by offering a wide range of services and resources. From professional grooming and veterinary services to pet training and daycare, we are here to support you and your furry friends. Join us on our mission to provide the best care for your beloved pets, ensuring they lead happy and healthy lives.
        </p>
        <a href="#" className="btn">Book now</a>
      </div>
      <div className="home-img">
        <img src="https://scontent.fsgn5-10.fna.fbcdn.net/v/t39.30808-6/440942530_423620990437817_5689570377664203254_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeGH7MPTf2dzUW3ThUsw3HmXDDoRkmzJd3IMOhGSbMl3cpvAmH2puahNUM-H3cX522nwwjSb-77rqIf3YpNqmHfJ&_nc_ohc=pRyaLPx__BYQ7kNvgG7oi2O&_nc_ht=scontent.fsgn5-10.fna&oh=00_AYDPeV8x1QY0gBNXtPfoYvwmWEMuIc2fqy9FS_Mg1FVQiA&oe=664E6D92" alt="" />
      </div>
    </section>
